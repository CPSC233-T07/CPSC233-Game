...
public class Spawner {
	...
	public static void spawnNature() {
		...
		FXGL.spawn("tree",2200,855);
		FXGL.spawn("tree",2400,900);
		FXGL.spawn("appleTree",2450,950);
		FXGL.spawn("bush",2430,870);
		...
		FXGL.spawn("rock",2300,2000);
		FXGL.spawn("appleTree",2250,1870);
		FXGL.spawn("appleTree",2300,1500);
	...
	public static void spawnBuildings() {
		...
		FXGL.spawn("blueHouse", 933, 2300);
		FXGL.spawn("redHouse", 1133, 2300);
		FXGL.spawn("blueHouse", 1333, 2300);
		FXGL.spawn("redHouse",1533,2300);
		
		
	    FXGL.spawn("lightHouse",2600,2600);
	    FXGL.spawn("greenHouse",2386,2394);
